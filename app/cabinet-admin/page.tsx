...
import { isAdminAuthenticated } from '~/lib/cabinet-admin/auth';
...
// Internal, password-gated admin panel for editing the cabinet collections' metafields. Not indexed.
...
export default async function CabinetAdminPage() {
  ...
  return <CabinetAdminPanel collections={withData} />;
}
