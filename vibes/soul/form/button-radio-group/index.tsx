        ...
        >
          {options.map((option) => (
            <RadioGroupPrimitive.Item
              ...
              className={clsx(
                'h-9 whitespace-nowrap rounded-full border px-4 font-body text-sm font-normal leading-normal transition-colors focus-visible:outline-0 focus-visible:ring-2 data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
                {
                  light:
