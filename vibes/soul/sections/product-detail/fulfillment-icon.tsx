...
/**
 * Delivery / pickup icon (hand holding a package) used in the PDP fulfillment box.
 * Inherits color via `currentColor` so it can be tinted through the parent's text color.
 */
export function FulfillmentIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      aria-hidden="true"
      className={className}
